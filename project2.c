...
/* << Include your information here - Kavi Chand, kcha612, 480142025  >> */
...
/*
This is the main function that calls function InitialiseFloor and PrintFloor
*/
int main()
{
	...
	AddContainer(floor, 26, 2, 0);
	AddContainer(floor, 12, 3, 1);
	PrintFloor(floor);
	printf("Avalible Area: %f sq ft\n", FloorAreaAvailable(floor, 10.5, 25.6));

	isBlocked = LocateContainer(floor, 'E', &rowA, &colA, &rowB, &colB);
